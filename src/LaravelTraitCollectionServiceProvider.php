...
class LaravelTraitCollectionServiceProvider extends ServiceProvider
{
    /**
    ...
    {
        $this->mergeConfigFrom(__DIR__.'/../config/laraveltraitcollection.php', 'laraveltraitcollection');

        // Register the service the package provides.
        $this->app->singleton('laraveltraitcollection', function ($app) {
            return new LaravelTraitCollection;
        });
    }
    ...
    protected function bootForConsole()
    {
        ...
        // $this->publishes([
        //     __DIR__.'/../config/laraveltraitcollection.php' => config_path('laraveltraitcollection.php'),
        // ], 'laraveltraitcollection.config');

        // Publishing the views.
        /*$this->publishes([
            __DIR__.'/../resources/views' => base_path('resources/views/vendor/alexschmidhuber'),
        ], 'laraveltraitcollection.views');*/
